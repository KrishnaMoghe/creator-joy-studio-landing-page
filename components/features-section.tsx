            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  ...
                  className="rounded-2xl border border-gray-700 bg-[#1a1a1a]/80 backdrop-blur-xl transition-all duration-300"
                >
                  <div className="relative z-10 p-8 h-full flex flex-col">
                    {/* Large gradient icon */}
                    <div className="mb-6 inline-flex rounded-xl bg-gradient-to-br from-purple-500 to-cyan-500 p-5 w-fit">
