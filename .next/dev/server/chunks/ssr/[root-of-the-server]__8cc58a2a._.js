...
;
const metadata = {
    title: "CreatorJoy Studio - Empower Your Creative Journey",
    description: "The ultimate platform for creators to monetize, grow, and thrive. Join thousands of creators building their dream with CreatorJoy Studio.",
    generator: "v0.app",
    icons: {
        icon: [
            {
